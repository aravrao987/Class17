...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    //scoring
    //with frame rate the score and its function will go back to 0.
...
function reset (){
  score = 0;
  //obstacles and clouds should be destroyed and reset for the game
  obstaclesGroup.destroyEach();
  cloudsGroup.destroyEach();
  //after pressing reset button, gameState should turn into play
  gameState = PLAY
}
